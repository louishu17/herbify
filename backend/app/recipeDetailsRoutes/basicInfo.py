...
def feed(recipeID):
    ...
    try:
        ...
        return jsonify({'title' : recipe.title, 'author' : 'User ' + str(recipe.postedByUserID), 'dateCreated' : recipe.createdDate, 'imageS3Filename': recipe.imageS3Filename, 'numLikes': recipe.numLikes}), 201
