...
class Recipes(Base):
    ...
    isKidFriendly = Column(Boolean, default=False)
    isVegetarian = Column(Boolean, default=False)
    isKeto = Column(Boolean, default=False)
    isSpicy = Column(Boolean, default=False)
    isHealthy = Column(Boolean, default=False)
    isDairyFree = Column(Boolean, default=False)
    isNutFree = Column(Boolean, default=False)
...
class RecipeHasIngredients(Base):
    ...
    ingredientID = Column(
        Integer, ForeignKey("Ingredients.ingredientID"), primary_key=True
    )
