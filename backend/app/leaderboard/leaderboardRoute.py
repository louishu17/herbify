...
def leaderboard():
    """
    Retrieve the leaderboard containing the top leaders.

    Returns:
        Response: A JSON response containing the leaderboard information.

    Raises:
        Exception: If there is an error while retrieving the leaderboard.
    """
