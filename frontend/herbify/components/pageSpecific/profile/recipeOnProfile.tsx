...
export const RecipeOnProfile : React.FC<RecipeOnProfileProps> = (props : RecipeOnProfileProps) => {
    return (
        ...
        <RecipeOnFeed info={{recipeID : props.data.recipeID, imageS3Filename : props.data.imageS3Filename, caption : props.data.caption, title : props.data.title}}></RecipeOnFeed>
